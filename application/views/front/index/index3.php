...
<div class="slider_area home_seven_slider owl-carousel">
        <div class="single_slider" data-bgimg="/assets/front/img/slider/slider13.jpg">
           <div class="slider_content_inner">
                <div class="slider_content">
                   <h2>new arrivals</h2>
                    <h1>autumn</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel similique perspiciatis, tempore unde </p>
                    <a href="shop.html">Discover Now</a>
                </div>  
            </div>     
        </div>
        <div class="single_slider" data-bgimg="/assets/front/img/slider/slider14.jpg">
           <div class="slider_content_inner">
                <div class="slider_content">
                    <h2>top products</h2>
                    <h1>packback</h1>
        ...
        <div class="single_slider" data-bgimg="/assets/front/img/slider/slider15.jpg">
           <div class="slider_content_inner">
                <div class="slider_content">
  ...
  <!--product section area start-->
    ...
    <!--banner area start-->
    <div class="banner_section banner_section_two banner_seven">
        <div class="container-fluid">
            <div class="row ">
               <div class="col-lg-6 col-md-6">
                    <div class="banner_area">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="/assets/front/img/bg/banner27.jpg" alt="#"></a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="banner_area">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="/assets/front/img/bg/banner28.jpg" alt="#"></a>
                            <div class="banner_content">
