...
class Employee_model extends CI_Model{
	...
	function fetch_data()
 {
 $this->db->select("txn_id,name,email,phone,paid_amount,created,charge_by");
	$this->db->where('employee_id',$_SESSION['Employee_session']);
  ...
  return $this->db->get();
	...
	function get_customer_info($user_id,$select='*'){

		return $this->db->select($select)->get_where('customers',['id' => $user_id])->row();
